        ...
        <main className="container mx-auto px-4 py-16 md:py-24 max-w-7xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12">
                {[
                    ...
                    { src: "/images/portfolio/margaridas-beauty-sudoeste-terapia-capilar-brasilia-002.jpg", title: "Nail Art", category: "Unha" },
                    ...
                    { src: "/images/portfolio/margaridas-beauty-sudoeste-terapia-capilar-brasilia-022.jpg", title: "Reconstrução Profunda", category: "Sobrancelha" },
